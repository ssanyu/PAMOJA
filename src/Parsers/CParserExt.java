...
public  abstract class CParserExt extends CParser{
     ...
     *
     */
    protected ArrayList<CTreeNode> treeStack;

    /**
     *
     */
    protected ArrayList<CNode> fNodeStack; //Stack of trees 
    /**
     *
     */
   ...
   //Tree Builder helpers
    ...
    public void setTreeStack(ArrayList<CTreeNode> treeStack) {
        ...
        this.treeStack.addAll(treeStack);
    }
     ...
     * @param fNodeStack
     */
    public void setNodeStack(ArrayList<CNode> fNodeStack) {
        this.fNodeStack =new ArrayList();
        this.fNodeStack.addAll(fNodeStack);
   }
}
