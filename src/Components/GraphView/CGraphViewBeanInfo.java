...
/**
 * This class implements Java's BeanInfo interface to restrict the TreeGraphView's features exposed to the public. That is, the properties, methods and events.
 *
 * 
 * 
 * @author Jackline Ssanyu (jssanyu@kyu.ac.ug)
 */
public class CGraphViewBeanInfo extends SimpleBeanInfo {
    ...
    // Here you can add code for customizing the BeanDescriptor.
     // create the bean descriptor object
        beanDescriptor = new BeanDescriptor(CGraphView.class,null);
        // set the display name
        beanDescriptor.setDisplayName("GraphView");
         beanDescriptor.setShortDescription("A view for different kinds of graphs.");
         return beanDescriptor;     }                         
    // Property identifiers
    private static final int PROPERTY_Parser = 0;
    private static final int PROPERTY_regularExpresion=1;
    ...
    // Here you can add code for customizing the properties array.
        ...
        try {
             properties[PROPERTY_Parser] = new PropertyDescriptor ( "Parser", CGraphView.class, "getParser", "setParser" ); // NOI18N
             properties[PROPERTY_regularExpresion] = new PropertyDescriptor ( "regularExpresion", CGraphView.class, "getRegularExpresion", "setRegularExpresion" ); // NOI18N
    ...
    // Here you can add code for customizing the properties array.
        ...
        try {
             properties[PROPERTY_Parser] = new PropertyDescriptor ( "Parser", CGraphView.class, "getParser", "setParser" ); // NOI18N
             properties[PROPERTY_regularExpresion] = new PropertyDescriptor ( "regularExpresion", CGraphView.class, "getParser", "setParser" ); // NOI18N
               }
        catch(IntrospectionException e) {
            e.printStackTrace();
        }
    ...
    public java.awt.Image getIcon(int iconType) {
              ...
              if (iconType == BeanInfo.ICON_COLOR_16x16) {
                                img =loadImage("GraphView_Icon.gif");
                                //return img;
                }
