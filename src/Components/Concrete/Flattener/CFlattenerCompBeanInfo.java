...
/**
 * This class implements Java's BeanInfo interface to restrict the Flattener's features exposed to the public. That is, the properties, methods and events.
 *
 * 
 * 
 * @author Jackline Ssanyu (jssanyu@kyu.ac.ug)
 */
public class CFlattenerCompBeanInfo extends SimpleBeanInfo {
    ...
    // Here you can add code for customizing the BeanDescriptor.
     // create the bean descriptor object
        beanDescriptor = new BeanDescriptor(CFlattenerComp.class,null);
        // set the display name
        beanDescriptor.setDisplayName("Flattener");
        beanDescriptor.setShortDescription("A component which transforms a parse tree to a symbol stream.");
         return beanDescriptor;     }                         
    // Property identifiers
    private static final int PROPERTY_ParseTree = 0;
    private static final int PROPERTY_SymbolStream = 1;
    private static final int PROPERTY_ParseTreeNode = 2;
    ...
    // Here you can add code for customizing the properties array.
        ...
        try {
             properties[PROPERTY_ParseTree] = new PropertyDescriptor ( "ParseTree", CFlattenerComp.class, "getParseTree", "setParseTree" ); // NOI18N
             properties[PROPERTY_SymbolStream] = new PropertyDescriptor ( "SymbolStream", CFlattenerComp.class, "getSymbolStream", "setSymbolStream" ); // NOI18N
             properties[PROPERTY_ParseTreeNode] = new PropertyDescriptor ( "ParseTreeNode", CFlattenerComp.class, "getParseTreeNode", "setParseTreeNode" ); // NOI18N
    ...
    // Here you can add code for customizing the event sets array.
      eventSets = new EventSetDescriptor[1];
        ...
        try {
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( CFlattenerComp.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
        }
