 ...
 */
public abstract class CViewTableModel extends AbstractTableModel{
     ...
     *
     */
    protected ArrayList<CNTermSet> firstSets;

    /**
     *
     */
    protected String[] fColumnNames={"NonTerminal","First Sets"};
