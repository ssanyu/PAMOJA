 ...
 */
public class CParserVisualizerBeanInfo extends SimpleBeanInfo {
    ...
    // Here you can add code for customizing the BeanDescriptor.
     // create the bean descriptor object
        beanDescriptor = new BeanDescriptor(CParserVisualizer.class,null);
        // set the display name
        beanDescriptor.setDisplayName("ParserVisualizer");
         beanDescriptor.setShortDescription("A visualizer for both top-down and bottom-up tree construction");
    ...
    // Here you can add code for customizing the properties array.
        ...
        try {
             properties[PROPERTY_Parser] = new PropertyDescriptor ( "Parser", CParserVisualizer.class, "getParser", "setParser" ); // NOI18N
