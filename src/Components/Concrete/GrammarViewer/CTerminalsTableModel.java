 ...
 */
public class CTerminalsTableModel extends CGrammarViewerTableModel{
        ...
        // int rowCount=vSymbolCount+vKeywordsCount;
         ...
         for(int i=0;i<vSymbolCount;i++){
            ...
            if(vTermDef.hasData()){
             ...
             fData[i][0]=vName;
             fData[i][1]=GrammarStructure.getGrammarContext().getTerminalDefs().getElt(i).getBody().toString();
         }
