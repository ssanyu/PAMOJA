 ...
 */
public class CNonterminalsTableModel extends CGrammarViewerTableModel{
   ...
   public void updateNonterminalsTable(CGrammar aGrammarStructure){
         ...
         for(int i=0;i<vSymbolCount;i++){
             ...
             fData[i][1]=GrammarStructure.getGrammarContext().getNonTerminalDefs().getElt(i).getBody().toString();
         }
