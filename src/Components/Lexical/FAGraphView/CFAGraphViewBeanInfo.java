 ...
 */
public class CFAGraphViewBeanInfo extends SimpleBeanInfo {
    ...
    // Here you can add code for customizing the BeanDescriptor.
     // create the bean descriptor object
        beanDescriptor = new BeanDescriptor(CFAGraphView.class,null);
        // set the display name
        beanDescriptor.setDisplayName("FAGraph");
         beanDescriptor.setShortDescription("A Viewer for NFA graph");
    ...
    // Here you can add code for customizing the properties array.
        ...
        try {
             properties[PROPERTY_Parser] = new PropertyDescriptor ( "Parser", CFAGraphView.class, "getParser", "setParser" ); // NOI18N
