 ...
 */
public class CRichTextEditorBeanInfo extends SimpleBeanInfo {
    ...
    // Here you can add code for customizing the BeanDescriptor.
     // create the bean descriptor object
        beanDescriptor = new BeanDescriptor(CRichTextEditor.class,null);
    ...
    private static final int PROPERTY_StreamtoText = 6;
    ...
    // Here you can add code for customizing the properties array.
        ...
        try {
             properties[PROPERTY_Text] = new PropertyDescriptor ( "Text", CRichTextEditor.class, "getText", "setText" ); // NOI18N
             properties[PROPERTY_Highlighting] = new PropertyDescriptor ( "Highlighting", CRichTextEditor.class, "isHighlighting", "setHighlighting" ); // NOI18N
             properties[PROPERTY_SymbolStyleCustomizer] = new PropertyDescriptor ( "SymbolStyleCustomizer", CRichTextEditor.class, "getSymbolStyleCustomizer", "setSymbolStyleCustomizer" ); // NOI18N
             properties[PROPERTY_Scanner] = new PropertyDescriptor ( "Scanner", CRichTextEditor.class, "getScanner", "setScanner" ); // NOI18N
             properties[PROPERTY_hybridEditor] = new PropertyDescriptor ( "hybridEditor", CRichTextEditor.class, "getHybridEditor", "setHybridEditor" ); // NOI18N
             properties[PROPERTY_presentation] = new PropertyDescriptor ( "presentation", CRichTextEditor.class, "getPresentation", "setPresentation" ); // NOI18N
             properties[PROPERTY_StreamtoText] = new PropertyDescriptor ( "StreamtoText", CRichTextEditor.class, "getStreamtoText", "setStreamtoText" ); // NOI18N
        }
    ...
    // Here you can add code for customizing the event sets array.
      eventSets = new EventSetDescriptor[1];
        ...
        try {
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( CRichTextEditor.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
        }
