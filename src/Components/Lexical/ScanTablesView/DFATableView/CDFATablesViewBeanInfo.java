 ...
 * @author jssanyu
 */
public class CDFATablesViewBeanInfo extends SimpleBeanInfo {
    ...
    // Here you can add code for customizing the BeanDescriptor.
     // create the bean descriptor object
        beanDescriptor = new BeanDescriptor(CDFATablesView.class,null);
        // set the display name
        beanDescriptor.setDisplayName("DFATablesView");
        beanDescriptor.setShortDescription("A view that displays DFA data in a tabular form.");
    ...
    // Here you can add code for customizing the properties array.
        ...
        try {
             properties[PROPERTY_ScanTables] = new PropertyDescriptor ( "ScanTables", CDFATablesView.class, "getScanTables", "setScanTables" ); // NOI18N
               }
    ...
    // Here you can add code for customizing the event sets array.
      eventSets = new EventSetDescriptor[1];
        ...
        try {
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( CDFATablesView.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
        }
   ...
   public java.awt.Image getIcon(int iconType) {
              ...
              if (iconType == BeanInfo.ICON_COLOR_16x16) {
                                img = loadImage("DFATablesView_Icon.jpg");
                                //return img;
                }
