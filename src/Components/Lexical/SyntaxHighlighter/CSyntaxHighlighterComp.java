 ...
 * @see Components.Lexical.RichTextEditor.CRichTextEditor
 * 
...
public class CSyntaxHighlighterComp extends javax.swing.JPanel implements Serializable,IPAMOJAComponent,ISyntaxHighlighterComp,PropertyChangeListener{
   ...
   public void setLanguage(ILanguageComp language){
    ...
    private void initComponents() {
        ...
        RichTextView = new Components.Lexical.RichTextEditor.CRichTextEditor();
    ...
    private Components.Lexical.RichTextEditor.CRichTextEditor RichTextView;
    ...
    public CRichTextEditor getRichTextView() {
        return RichTextView;
    }

   
    public void setRichTextView(CRichTextEditor RichTextView) {
