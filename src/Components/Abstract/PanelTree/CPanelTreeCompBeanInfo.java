...
/**
 * Use the Java's BeanInfo interface to create a BeanInfo class and provide explicit information about the methods, properties, events, and other features of the PanelTree. 
 * 
 * @author Jackline Ssanyu (jssanyu@kyu.ac.ug)
 */
public class CPanelTreeCompBeanInfo extends SimpleBeanInfo {
        // Property identifiers
    private static final int PROPERTY_presentation=0;
    private static final int PROPERTY_language=1;
    private static final int PROPERTY_hybridEditor=2;
 ...
 // create the bean descriptor object
        beanDescriptor = new BeanDescriptor(CPanelTreeComp.class,null);
        // set the display name
        beanDescriptor.setDisplayName("PanelTreeView");
        beanDescriptor.setShortDescription("A component that holds a tree of nested panels for a corresponding AST");
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
             properties[PROPERTY_presentation] = new PropertyDescriptor ( "presentation", CPanelTreeComp.class, "getPresentation", "setPresentation" ); // NOI18N
             properties[PROPERTY_language] = new PropertyDescriptor ( "language", CPanelTreeComp.class, "getLanguage", "setLanguage" ); // NOI18N
             properties[PROPERTY_hybridEditor] = new PropertyDescriptor ( "hybridEditor", CPanelTreeComp.class, "getHybridEditor", "setHybridEditor" ); // NOI18N
        }
 ...
 eventSets = new EventSetDescriptor[1];
        ...
        try {
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( CPanelTreeComp.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
        }
