...
/**
 * An implementation of the Java's BeanInfo interface to restrict the BoxTree2Stream component's features exposed to the public. That is, the properties, methods and events.
 *
 * 
 * 
 * @author Jackline Ssanyu (jssanyu@kyu.ac.ug)
 */
public class CBoxTree2StreamCompBeanInfo extends SimpleBeanInfo {
    ...
    // Here you can add code for customizing the BeanDescriptor.
     // create the bean descriptor object
        beanDescriptor = new BeanDescriptor(CBoxTree2StreamComp.class,null);
        // set the display name
        beanDescriptor.setDisplayName("BoxTree2Stream");
        beanDescriptor.setShortDescription("A component that converts a box tree to a symbol stream.");
         return beanDescriptor;     }                         
    // Property identifiers
    private static final int PROPERTY_BoxTree = 0;
    private static final int PROPERTY_SymbolStream = 1;
    private static final int PROPERTY_ASTtoBoxTree = 2;
    ...
    // Here you can add code for customizing the properties array.
        ...
        try {
             properties[PROPERTY_ASTtoBoxTree] = new PropertyDescriptor ( "ASTtoBoxTree", CBoxTree2StreamComp.class, "getASTtoBoxTree", "setASTtoBoxTree" ); // NOI18N
             properties[PROPERTY_SymbolStream] = new PropertyDescriptor ( "SymbolStream", CBoxTree2StreamComp.class, "getSymbolStream", "setSymbolStream" ); // NOI18N
             properties[PROPERTY_BoxTree] = new PropertyDescriptor ( "BoxTree", CBoxTree2StreamComp.class, "getBoxTree", "setBoxTree" ); // NOI18N
    ...
    // Here you can add code for customizing the event sets array.
      eventSets = new EventSetDescriptor[1];
        ...
        try {
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( CBoxTree2StreamComp.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
        }
