...
/** 
 * An implementation of a table model for context items of a signature.
 *
 * 
 * @author Jackline Ssanyu (jssanyu@kyu.ac.ug)
 */
public class CtxtTableModel extends AbstractTableModel{
  ...
  */
     ...
     * @param aList
     */
    public void updateCtxtTable(CMemberDefinition_List aList){
