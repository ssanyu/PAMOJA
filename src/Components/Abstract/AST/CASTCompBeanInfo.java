...
/**
 * This class implements Java's BeanInfo interface to restrict the AST component's features exposed to the public. That is, the properties, methods and events.
 *
 * 
 * 
 * @author Jackline Ssanyu (jssanyu@kyu.ac.ug)
 */
public class CASTCompBeanInfo extends SimpleBeanInfo {
        // Property identifiers
    private static final int PROPERTY_ASTStructure = 0;
    private static final int PROPERTY_Abstractor=1;
 ...
 // create the bean descriptor object
        beanDescriptor = new BeanDescriptor(CASTComp.class,null);
        // set the display name
        beanDescriptor.setDisplayName("AST");
        beanDescriptor.setShortDescription("A component that holds an abstract syntax tree.");
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            // properties[PROPERTY_SymbolStreamText] = new PropertyDescriptor ( "SymbolStreamText", CSymbolStreamComp.class, "getSymbolStreamText", "setSymbolStreamText" ); // NOI18N
             properties[PROPERTY_ASTStructure] = new PropertyDescriptor ( "ASTStructure", CASTComp.class, "getASTStructure", "setASTStructure" ); // NOI18N
             properties[PROPERTY_ASTStructure].setDisplayName ( "ASTStructure" );
             properties[PROPERTY_ASTStructure].setShortDescription ( "AST Internal Structure" );
             properties[PROPERTY_Abstractor] = new PropertyDescriptor ( "Abstractor", CASTComp.class, "getAbstractor", "setAbstractor" ); // NOI18N
 ...
 eventSets = new EventSetDescriptor[1];
        ...
        try {
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( CASTComp.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
        }
