 ...
 */
public class CTreeGraphViewBeanInfo extends SimpleBeanInfo {
    ...
    // Here you can add code for customizing the BeanDescriptor.
     // create the bean descriptor object
        beanDescriptor = new BeanDescriptor(CTreeGraphView.class,null);
        // set the display name
        beanDescriptor.setDisplayName("TreeGraphView");
         beanDescriptor.setShortDescription("A view that displays trees in textbook form (e.g., NFA, parse trees and abstract syntax trees).");
    ...
    // Here you can add code for customizing the properties array.
        ...
        try {
             properties[PROPERTY_NodeObject] = new PropertyDescriptor ( "NodeObject", CTreeGraphView.class, "getNodeObject", "setNodeObject" ); // NOI18N
               }
    ...
    public java.awt.Image getIcon(int iconType) {
              ...
              if (iconType == BeanInfo.ICON_COLOR_16x16) {
                                img = loadImage("TreeGraphView_Icon.gif");
                                //return img;
                }
